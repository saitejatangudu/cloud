...
def save_predictions_to_csv(predicted_scores, corresponding_mos, corresponding_name, dataset_name, results_dir):
   csv_file_path = os.path.join(results_dir, f"{dataset_name}_predictions.csv")
   with open(csv_file_path, mode='w', newline='') as csv_file:
       writer = csv.writer(csv_file)
       writer.writerow(["Image Name", "MOS (Ground Truth)", "Predicted Value"])
...
def get_dataset_info():
   return {
       'kadid': {
           ...
           'img_dir': '/home/sanjotst/llm_iqa/llm-iqa/datasets/kadid10k/images'
       },
       'koniq': {
           'json_path': '/home/sanjotst/llm_iqa/llm-iqa/labels/koniq.json',
           'img_dir': '/home/sanjotst/llm_iqa/llm-iqa/datasets/KonIQ-10k/512x384'
       },
       'livec': {
           'json_path': '/home/sanjotst/llm_iqa/llm-iqa/labels/livec.json',
           'img_dir': '/ home/sanjotst/llm_iqa/ll

m-iqa/datasets/CLIVE/ChallengeDB_release/Images'
       },
       'pipal': {
           'json_path': '/home/sanjotst/llm_iqa/llm-iqa/labels/pipal.json',
           'img_dir': '/home/sanjotst/llm_iqa/llm-iqa/datasets/PIPAL'
       },
       'spaq': {
           'json_path': '/home/sanjotst/llm_iqa/llm-iqa/labels/spaq.json',
           'img_dir': '/home/sanjotst/llm_iqa/llm-iqa/datasets/SPAQ_512/TestImage'
       }
   }
...
def test_all_datasets(config):
   ...
   for dataset_name, dataset_paths in dataset_info.items():
       ...
       srcc, plcc, predicted_scores, corresponding_mos, corresponding_name = test_model(config)
       results[dataset_name] = {'SRCC': srcc, 'PLCC': plcc}
       save_predictions_to_csv(predicted_scores, corresponding_mos, corresponding_name, dataset_name, results_dir)
...
### Explanation:
- **save_predictions_to_csv**: A new function to save predictions to a CSV file.
- **test_all_datasets**: Modified to include the call to `save_predictions_to_csv` after predictions are made for each dataset.
- The script will now generate a CSV file for each dataset in the results directory, containing image names, ground truth MOS values, and predicted scores.
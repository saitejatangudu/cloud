...
class DNNIter(nn.Module):
    def __init__(self, config):
        ...
        self.model = get_mplug_owl_model(self.config)
...
def configuration_params():
    ...
    parser.add_argument('--optimizer_params', type=list,
                        default=['visual_abstractor'])
    ...
    parser.add_argument('--results_dir', type=str,
                        default='/scratch/sanjotst/old_script_results_mplug')
    ...
    parser.add_argument('--resume_model_path', type=str,
                        default='/home/sanjotst/llm_iqa/llm-iqa/code/baselines/exp2_2_results_folder/Run0015/Train/iter_945.tar')
    parser.add_argument('--model_description', type=str, default='mplug_owl')

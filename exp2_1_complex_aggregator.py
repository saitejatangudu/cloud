...
# From our files
from util_dataload import CustomDataset, get_livefb_train_data
...
def configuration_params():
    ...
    parser.add_argument('--resume_model_path', type=str,
                        default='/home/sanjotst/llm_iqa/llm-iqa/code/baselines/exp2_results_folder/Run0046/Train/iter_945.tar')
    parser.add_argument('--exp description', type=str,
                        default='uses complex multiheaded attention aggregator, changed learning rate to 1e-4')

...
from util_networks import get_internLM_model, NormalRegressor1, NormalRegressor, ComplexMultiheadAttentionAggregator, BasicMultiheadAttentionAggregator
...
def configuration_params():
    ...
    parser.add_argument('--synthetic_img_dir', type=str,
                        default='/scratch/sanjotst/datasets/live_fb_synthetic/LIVE_FB_synthetic_full_v2')
    ...
    parser.add_argument('--results_dir', type=str,
                        default='/scratch/sanjotst/old_script_results')
    ...
    parser.add_argument('--resume_model_path', type=str,
                        default='/scratch/sanjotst/old_script_results/Run0011/Train/iter_3780.tar')
    parser.add_argument('--model_description', type=str, default='internlm_vl')
    parser.add_argument('--experiment details', type=str,
                        default='using NormalRegressor1 as a regressor')
